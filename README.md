...
- Защиту ${\color{green}stihi.ru}$ осуществляет сервис ${\color{red}Qrator}$, на момент релиза настройки парсера позволяют обходить ограничения. Но не гарантируется, что в будущем не понадобится изменить настройки.